...
(function() {
    ...
    function startPlugin() {
        ...
        function updateText() {
            ...
            toggleMiniBtn.textContent = miniBtnVisible ? l.toggleMiniBtn : (currentLang === 'zhCN' ? '显示按钮' : currentLang === 'en' ? 'Show Button' : '顯示按鈕');
        }
        ...
        timerDisplay.style.color = '#ffd740';
        timerDisplay.style.fontWeight = 'bold';

        const statusText = document.createElement('div');
        statusText.style.fontSize = '12px';
        statusText.style.color = '#ffd740';
        ...
        flightNoSpan.style.color = '#40ffdc';
        ...
        flightNoInput.style.border = '1px solid #00ccff';
        flightNoInput.style.borderRadius = '4px';
        flightNoInput.style.background = 'rgba(255,255,255,0.05)';
        flightNoInput.style.color = '#fff';
        ...
        acTypeInput.style.border = '1px solid #00ccff';
        acTypeInput.style.borderRadius = '4px';
        acTypeInput.style.background = 'rgba(255,255,255,0.05)';
        acTypeInput.style.color = '#fff';
        ...
        depInput.style.border = '1px solid #00ccff';
        depInput.style.borderRadius = '4px';
        depInput.style.background = 'rgba(255,255,255,0.05)';
        depInput.style.color = '#fff';
        ...
        arrInput.style.border = '1px solid #00ccff';
        arrInput.style.borderRadius = '4px';
        arrInput.style.background = 'rgba(255,255,255,0.05)';
        arrInput.style.color = '#fff';
        ...
        eteInput.style.border = '1px solid #00ccff';
        eteInput.style.borderRadius = '4px';
        eteInput.style.background = 'rgba(255,255,255,0.05)';
        eteInput.style.color = '#fff';
        ...
        langBtn.style.background = '#2979ff';
        ...
        resetBtn.style.background = '#ea80fc';
        ...
        miniBtn.style.left = '10px';      // 靠左
        miniBtn.style.bottom = '60px';    // 底部工具栏上方
        miniBtn.style.padding = '8px 14px';
        miniBtn.style.fontSize = '14px';
        miniBtn.style.borderRadius = '8px';
        miniBtn.style.background = '#1a237e';
        ...
        langBtn.addEventListener('click', () => {
            currentLang = currentLang === 'zhCN' ? 'en' : currentLang === 'en' ? 'zhTW' : 'zhCN';
            updateText();
        });
